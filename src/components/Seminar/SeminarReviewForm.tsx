    ...
    <div className="flex flex-col px-20 gap-48 items-start">
      <div className="w-[335px] h-[189px] flex flex-col items-start gap-12">
        <div className="flex flex-row gap-4">
          <div className="heading-3-semibold text-black ">세미나의 좋았던 점을 남겨주세요</div>
      ...
      <div className="w-[335px] h-[189px] flex flex-col gap-12">
        <div className="heading-3-semibold text-black ">세미나의 아쉬웠던 점을 남겨주세요</div>
      ...
      <div className="w-[335px] h-[189px] flex flex-col gap-12">
        <div className="heading-3-semibold text-black ">다음 회차에서 듣고 싶은 주제가 있나요?</div>
