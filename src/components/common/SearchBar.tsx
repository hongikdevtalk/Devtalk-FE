    ...
    <div className="w-full flex flex-col gap-3">
      <div className="w-full inline-flex justify-between items-center">
        <input
          ...
          className="w-full text-black heading-3-regular outline-none bg-transparent placeholder:text-grey-700"
        />
      ...
      <div className="w-full inline-flex justify-start items-start gap-3 flex-wrap content-start">
        {tags.map((tag) => (
          ...
          >
            <span className="text-white body-1-medium"> # {tag.text}</span>
          </button>
        ))}
      </div>
    </div>
